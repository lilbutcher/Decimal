...
START_TEST(add_test_24) {
  s21_decimal dec1 = {{0}};
  s21_decimal dec2 = {{0}};
  dec1.bits[3] = 0b00000000000110000000000000000000;
  dec1.bits[2] = 0;
  dec1.bits[1] = 0xF;
  dec1.bits[0] = 0x67E4FEEF;
  dec2.bits[3] = 0b00000000000110000000000000000000;
  dec2.bits[2] = 0;
  dec2.bits[1] = 0xFF;
  dec2.bits[0] = 0x67E4FFFF;
  s21_decimal res = {{0}};
  res.bits[3] = 0b00000000000110000000000000000000;
  res.bits[2] = 0;
  res.bits[1] = 0x10E;
...
START_TEST(add_fail_2) {
  // степень 154 (показатель степени должен быть от 0 до 28)
  // биты 0-15 не нули
  // биты 24-30 не нули
  s21_decimal decimal1 = {{0, 0, 0, 1000000000}};
  s21_decimal decimal2 = {
      {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0b00000000011101000000000000000000}};
  s21_decimal result;
  int error = s21_add(decimal1, decimal2, &result);

  ck_assert_int_ne(error, S21_ARITHMETIC_OK);
}
END_TEST

START_TEST(add_fail_3) {
  // степень 29
...
START_TEST(add_fail_5) {
  // степень 28, но биты 0-15 не нули (младший бит)
...
START_TEST(add_fail_6) {
  // степень 28), но биты 0-15 не нули (старший бит)
...
START_TEST(add_fail_7) {
  // степень 28, но биты 24-30 не нули (младший бит)
...
START_TEST(add_fail_8) {
  // степень 28, но биты 24-30 не нули (старший бит)
...
Suite* suite_add(void) {
  ...
  tcase_add_test(tc, add_fail_2);
  tcase_add_test(tc, add_fail_3);
  tcase_add_test(tc, add_fail_4);
  tcase_add_test(tc, add_fail_5);
  tcase_add_test(tc, add_fail_6);
  tcase_add_test(tc, add_fail_7);
  tcase_add_test(tc, add_fail_8);
  tcase_add_test(tc, add_fail_9);
  tcase_add_test(tc, add_fail_10);
  tcase_add_test(tc, add_fail_11);
  tcase_add_test(tc, add_fail_12);
  tcase_add_test(tc, add_fail_13);
  tcase_add_test(tc, add_fail_14);
  tcase_add_test(tc, add_fail_15);
  tcase_add_test(tc, add_fail_16);
  tcase_add_test(tc, add_fail_17);

...
START_TEST(s21_sub_fail_2) {
  ...
  s21_decimal result;
  int error = s21_sub(decimal1, decimal2, &result);

  ck_assert_int_ne(error, S21_ARITHMETIC_OK);
}
END_TEST

START_TEST(s21_sub_fail_3) {
...
START_TEST(s21_sub_BIG) {
  ...
  s21_decimal result;
  int error = s21_sub(decimal1, decimal2, &result);
  ck_assert_int_eq(error, S21_ARITHMETIC_BIG);
}
END_TEST

START_TEST(s21_sub_SMALL) {
  // -79228162514264337593543950335
  ...
  s21_decimal result;
  int error = s21_sub(decimal1, decimal2, &result);
  ck_assert_int_eq(error, S21_ARITHMETIC_SMALL);
}
END_TEST
...
Suite* suite_sub(void) {
  ...
  tcase_add_test(tc, s21_sub_fail_2);
  tcase_add_test(tc, s21_sub_fail_3);
  tcase_add_test(tc, s21_sub_fail_4);
  tcase_add_test(tc, s21_sub_fail_5);
  tcase_add_test(tc, s21_sub_fail_6);
  tcase_add_test(tc, s21_sub_fail_7);
  tcase_add_test(tc, s21_sub_fail_8);
  tcase_add_test(tc, s21_sub_fail_9);
  tcase_add_test(tc, s21_sub_fail_10);
  tcase_add_test(tc, s21_sub_fail_11);
  tcase_add_test(tc, s21_sub_fail_12);
  tcase_add_test(tc, s21_sub_fail_13);
  tcase_add_test(tc, s21_sub_fail_14);
  tcase_add_test(tc, s21_sub_fail_15);
  tcase_add_test(tc, s21_sub_fail_16);
  tcase_add_test(tc, s21_sub_fail_17);
  tcase_add_test(tc, s21_sub_BIG);
  tcase_add_test(tc, s21_sub_SMALL);

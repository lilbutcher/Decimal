...
START_TEST(is_equal_0) {
  ...
  s21_decimal_set_sign(&val2, S21_POSITIVE);
...
START_TEST(is_equal_1) {
  s21_decimal val1 = {{0}};
  s21_decimal val2 = {{0}};
  val2 = s21_decimal_set_bit(val2, 3);
...
START_TEST(is_equal_2) {
  s21_decimal val1 = {{0}};
  s21_decimal val2 = {{0}};
  val2 = s21_decimal_set_bit(val2, 127);
  val1 = s21_decimal_set_bit(val1, 33);
  val2 = s21_decimal_set_bit(val2, 33);
  ck_assert_int_eq(0, s21_is_equal(val1, val2));
}
END_TEST
...
START_TEST(is_equal_3) {
  s21_decimal val1 = {{0}};
  s21_decimal val2 = {{0}};
  val1 = s21_decimal_set_bit(val1, 3);
  val2 = s21_decimal_set_bit(val2, 3);
  ck_assert_int_eq(1, s21_is_equal(val1, val2));
}
END_TEST
...
START_TEST(is_equal_4) {
  ...
  s21_decimal val2 = {{0}};
  val1 = s21_decimal_set_bit(val1, 3);
  val2 = s21_decimal_set_bit(val2, 4);
  ck_assert_int_eq(0, s21_is_equal(val1, val2));
}
END_TEST
